  ...
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <form id="example-form" action="<?= base_url(); ?>/Pesantiket/simpan_pemesanan" method="POST">
          <div>
            <h3>Data Diri</h3>
            <section>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select name="kendaraan" class="form-control" id="gol" onchange="harga(this.value)" required>
                      ...
                      <option value="Golongan IVa">Golongan IV</option>
                      <!-- <option value="Golongan IVb">Golongan IV</option> -->
                      <option value="Golongan Va">Golongan V</option>
                      <option value="Golongan Vb">Golongan V</option>
                      <option value="Golongan VIa">Golongan VI</option>
                      <option value="Golongan VIb">Golongan VI</option>
